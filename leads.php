...
<div id="mainDiv">
	  ...
	  <script src="seller/js/bootstrap.min.js">
	  </script>
	  <script type="text/javascript">
$('#filterbutton').click(function () {
$("#table tbody tr").each(function() {var ck1 = 
  ...
  bootbox.confirm("Are you sure?", function(result) {
     ...
     success:function(data){
		 ...
		 $("#leads"+id).html(data).show();
            ...
            bootbox.alert('<center><img src="files/img/balance.png"><h2><b>No enough balance !</b>
	    </h2>
	    <h4>Please refill your balance <a class="btn btn-primary btn-xs"  href="addBalance.html" onclick="window.open(this.href);return false;" >Add Balance <span class="glyphicon glyphicon-plus"></span></a></h4></center>')
         }
     },
   });
       ;}
